...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Stuycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"stuycoin.com", "dnsseed.stuycoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"stuycoin.com", "testnet-seed.stuycoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Stuycoin is probably already running."), addrBind.ToString().c_str());
        else
